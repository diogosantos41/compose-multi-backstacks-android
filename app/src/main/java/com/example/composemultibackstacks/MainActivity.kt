package com.example.composemultibackstacks
...
import com.example.composemultibackstacks.ui.theme.ComposeMultiBackStacksTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ComposeMultiBackStacksTheme {
                val rootNavController = rememberNavController()
                Scaffold(
                    bottomBar = { BottomBarUI(rootNavController) }
                ) { padding ->
                    NavHost(
                        rootNavController,
    ...
    @Composable
    private fun BottomBarUI(navController: NavHostController) {
